...
install -m644 ${SHED_SRCDIR}System.map ${SHED_FAKEROOT}/boot/System.map-4.15
install -m755 ${SHED_SRCDIR}/arch/arm/boot/zImage ${SHED_FAKEROOT}/boot/linux-4.15-zImage
...
install -m644 ${DTBFILE} ${SHED_FAKEROOT}/boot/linux-4.15-${SHED_HWCONFIG}.dtb
